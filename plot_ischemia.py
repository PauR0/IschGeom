...
def plot_ischemia(opt, pl, sliders):
    ...
    grid_mesh, plotter = plot_block.plot_block()
    grid_mesh['scalars'] = get_ischemia.get_scalars(opt, grid_mesh.points, KWARGS_ISC)
...
def grid_updatter(opt, d, sx=DEFAULT_KWARGS_BLOCK['sx'], sy=DEFAULT_KWARGS_BLOCK['sy'], sz=DEFAULT_KWARGS_BLOCK['sz'],
    ...
    """
    grid = plot_block.create_grid_mesh(sx, sy, sz, dx, dy, dz)
    grid['scalars'] = get_ischemia.get_scalars(opt, grid.points, d)
    return grid

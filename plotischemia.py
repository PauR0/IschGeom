...
def plot_ischemia(opt, pl, sliders):
    """
    Plots an ischemia simulation based on the data obtained by the get_scalars() function on a grid mesh generated by the plot_block() function.
...
def grid_updatter(opt, d, sx=DEFAULT_KWARGS_BLOCK['sx'], sy=DEFAULT_KWARGS_BLOCK['sy'], sz=DEFAULT_KWARGS_BLOCK['sz'],
    ...
    """
    Generates a new 'pyvista.StructuredGrid' object based on the input parameters and the updated ischemia data. 
